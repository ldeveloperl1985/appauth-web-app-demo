...
// Represents the test web app that uses the AppAuthJS library.
    ...
    var openIdConnectUrl = 'https://gluu.local.org';
    /* example client configuration */
    var clientId = 'fdd62388-3c65-4a48-993c-149c771cd17c';
    var redirectUri = 'http://localhost:8000/redirect.html';
    var scope = 'openid';
    /**
        ...
        if (request) {
          this.tokenHandler.performTokenRequest(this.configuration, request)
            .then(function (response) {
              ...
              if (isFirstRequest) {
                logger_1.log('Obtained an access token ', response);
